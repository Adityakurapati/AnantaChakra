                        ...
                        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white overflow-x-hidden">
                                ...
                                <section ref={heroRef} className="min-h-screen flex items-center justify-center relative">
                                        ...
                                        <div className="container mx-auto px-4 sm:px-6 text-center z-10">
                                                ...
                                                <motion.p className="text-lg md:text-xl mb-12 text-gray-400 max-w-2xl mx-auto leading-relaxed">
                                                        Specializing in <strong>startup digital marketing</strong> and{" "}
                                                        <strong>affordable SEO services in India</strong>, we help early-stage companies establish their online
                                                        presence. As a leading <strong>digital marketing agency</strong>, our{" "}
                                                        <strong>remote marketing consultants</strong> deliver <strong>LinkedIn marketing packages</strong> and{" "}
                                                        <strong>cloud engineering solutions</strong> tailored for bootstrap budgets. Get expert{" "}
                                                        <strong>business SEO support</strong> and <strong>tech solutions</strong> to scale your startup.
                                                </motion.p>
                                        ...
                                        <div className="container mx-auto px-4 sm:px-6">
                                                ...
                                                >
                                                        ...
                                                        <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
                                                                We deliver expert-led{" "}
                                                                <a href="#services" className="text-purple-400 hover:underline">
                                                                        marketing consultant services
                                                                </a>{" "}
                                                                and{" "}
                                                                <a href="#services" className="text-purple-400 hover:underline">
                                                                        remote tech support solutions
                                                                </a>{" "}
                                                                tailored for small business SEO services and digital growth. Our 100% remote, global team is on call
                                                                24/7. From strategy to execution, we engineer sustainable success for your{" "}
                                                                <a href="#services" className="text-purple-400 hover:underline">
